                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" placeholder="Affiliation and Organisation" name="affiliation"
                                        id="affiliation" pattern="[a-zA-Z][a-zA-Z0-9\s]*" required>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4" id="paperidDiv" style="display:none;">
                                    <input type="number" onchange="showPaperid(this.value)"
                                        placeholder="Paper ID (Last Digits)" name=" paperid" id="paperid">
                                    <span id="availability"> </span>
                                </div>
